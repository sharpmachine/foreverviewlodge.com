...
<div id="watermarklist"><div class="obis">Loading content...</div></div>
</div>
            ...
            function(data){
                ...
                if(data.type!="video"){
                   ...
                   if(data.splash=="on"){ 
                       ...
                       jQuery('#detailsimg #splash').attr('checked', true);  //disabled="disabled"
...
<div id="detailsimg" style="display:none;">
  ...
  <form id="updateform" name="updateform" action="#null">
    ...
    <p id="p_splash"><input name="splash" id="splash" type="checkbox" class="splash"/> &nbsp; Set this photo as a gallery splash.</p>
	<p id="p_splashexclusive"><input name="splashexclusive" id="splashexclusive" class="splashexclusive" type="checkbox"/> &nbsp; Make it splash exclusive.</p>
    ...
    <p>Link <small>(ex: http://oqeysites.com), * Note: will work with supported commercial skins only.</small><br />
...
<input type="button" class="button-primary" style="width:100px; margin-top:5px;" value="<?php _e('Add video') ?>" onclick="SaveVideoImage(); return false;" />
</div>
</div>
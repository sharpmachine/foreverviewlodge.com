   ...
   foreach($imgs as $i) { 
    ...
    if($i->img_type=="video" && $_REQUEST['withvideo']=="true"){
       ...
       if($_REQUEST['withexif']=="true"){
        ...
        $r .= '<exif>';
             //foreach(json_decode($i->meta_data) as $meta){
            ...
            //}
            //$r .='<pre>'.print_r(json_decode($i->meta_data), true).'</pre>';
    ...
    //  <image file="rick_wenner_photography_40_1295285633.jpg" />
    //  <video type="video" file="rick_wenner_photography_40_1295285633.flv" />

...
echo '<div id="message" style="width:903px; margin-bottom:10px;"><p class="updated fade">Settings saved.</p></div>';
...
<tr valign="top">
<td height="25" align="left" valign="middle" scope="row">Limit the image size on fullscreen</td>
...
<tr valign="top">
<td height="25" align="left" valign="middle" scope="row">Crop images to fit the gallery size</td>
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="230" height="25">Effect transition type:</td>
    <td width="670">
...
<tr valign="top">
<th height="25" align="left" valign="middle" scope="row">Show captions under each photo</th>
<td height="25" align="left" valign="middle" scope="row"><input type="checkbox" name="oqey_show_captions_under_photos" id="oqey_show_captions_under_photos" <?php if(get_option('oqey_show_captions_under_photos')=="on"){ echo 'checked="checked"'; } ?> style="float:left;"/></td>
</tr>
<tr valign="top">
<th height="25" colspan="2" align="left" valign="middle" scope="row">&nbsp;</th>
</tr>

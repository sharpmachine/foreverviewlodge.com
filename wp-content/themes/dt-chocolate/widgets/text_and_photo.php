...
class techno_Text_Photo extends WP_Widget {
	...
	function techno_Text_Photo() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'techno-text-photo-widget', __(THEME_TITLE.' Text & Photo', 'smw'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if ($instance['img']) echo '<span class="alignleft"><img src="'.$instance['img'].'" width="60" height="60" /></span>';

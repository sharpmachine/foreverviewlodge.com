<?php
function dt_pagenavi($before = '', $after = '') {
	...
	if (!is_single()) {
	   ...
	   $pagenavi_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','dt');
	   $pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	   $pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	   $pagenavi_options['first_text'] = __('&laquo; First','dt');
	   $pagenavi_options['last_text'] = __('Last &raquo;','dt');
	   $pagenavi_options['prev_text'] = __('Newer posts','dt');
	   $pagenavi_options['next_text'] = __('Older posts','dt');
	   $pagenavi_options['dotright_text'] = __('','dt');
	   $pagenavi_options['dotleft_text'] = __('','dt');
				...
				case 1:
					...
					for($i = $start_page; $i <= $end_page; $i++) {						
						if($i == $paged) {
							...
							echo '<li class="act"><a class="'.esc_url(get_pagenum_link($i)).'"> '.$current_page_text.' </a></li>';
						} else {

...
?>
  ...
  <div id="aside">
    ...
    <div id="aside_c">
        ...
        <a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">
          <?php if (isset($options['logo']) && $options['logo']): ?>
             <img src="<?php
				...
				$tmp_src = explode($_SERVER['SERVER_NAME'], $url);
				$tmp_src = isset($tmp_src[1])?$tmp_src[1]:$url;
				echo esc_attr(get_template_directory_uri().'/thumb.php?src='.$tmp_src.'&w=220&zc=0&q=100&nores=1');
             ?>" alt="<?php wp_title(); ?>" />
          <?php else: ?>
             <img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="<?php wp_title(); ?>" width="181" height="144" />
          <?php endif; ?>
        </a>
      </div>
      ...
      <?php
      // if (!defined('GAL_HOME') && !is_page_template('home-video.php') && !is_page_template('home-slider.php') && !is_page_template('home-static.php'))

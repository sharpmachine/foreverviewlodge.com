   ...
   theme_header();
      ...
      <fieldset>
         ...
         <br style="clear: both;" />
            ...
            <div>
               ...
               <label>
                  <input type="checkbox" name="<?php echo LANGUAGE_ZONE; ?>_theme_options[bg<?php echo $num; ?>_center]" <?php if ($options['bg'.$num.'_center']) echo ' checked="checked"'; ?> /> center
               </label><br />
            </div>
      ...
      <fieldset>
		...
		<label>
			...
			<?php checked($options['show_credits']); ?>/>
			show credits
		</label>
	  </fieldset>
      <?php

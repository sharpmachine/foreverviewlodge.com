...
<input class="form_input" type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />



<label for="email">Email <?php if ($req) echo "(required)"; ?></label>
<input class="form_input" type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
...
<textarea class="form_textarea" name="comment" id="comment" cols="" rows="" tabindex="4"></textarea>
